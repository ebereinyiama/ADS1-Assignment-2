...
'CO2 emission':df_CO2_corr['Indonesia'], 'Renewable energy':df_energy_corr['Indonesia'], 
...
### Correlation of indicators for Australia

australia = pd.DataFrame({'Agricultural land':df_agric_corr['Australia'],
'CO2 emission':df_CO2_corr['Australia'], 'Renewable energy':df_energy_corr['Australia'], 
...
### Correlation of indicators for Kenya

kenya = pd.DataFrame({'Agricultural land':df_agric_corr['Kenya'],
'CO2 emission':df_CO2_corr['Kenya'], 'Renewable energy':df_energy_corr['Kenya'], 
...
### Correlation of indicators for Denmark

denmark = pd.DataFrame({'Agricultural land':df_agric_corr['Denmark'],
'CO2 emission':df_CO2_corr['Denmark'], 'Renewable energy':df_energy_corr['Denmark'], 
